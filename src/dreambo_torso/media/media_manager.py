...
from dreambo_torso.media.camera_constants import CameraSpecs
...
if TYPE_CHECKING:
    ...
    from dreambo_torso.media.camera_gstreamer import GStreamerCamera
    from dreambo_torso.media.webrtc_client_gstreamer import GstWebRTCClient
...
class MediaManager:
    ...
    def __init__(
        ...
        Example::
            ...
            from dreambo_torso.media.media_manager import MediaManager, MediaBackend
