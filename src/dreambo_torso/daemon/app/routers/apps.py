...
from dreambo_torso.apps.manager import AppManager, AppStatus
from dreambo_torso.daemon.app import bg_job_register
from dreambo_torso.daemon.app.dependencies import get_app_manager
...
async def install_private_space(
    ...
    """
    from dreambo_torso.apps.sources import hf_auth
...
async def check_app_updates(
    ...
    from dreambo_torso.apps.sources import app_update_checker
