#!/usr/bin/env python3
"""Bluetooth service for Dreambo robot using direct DBus API.
...
class BluetoothCommandService:
    ...
    def __init__(self, device_name="Dreambo", pin_code="00000"):
    ...
    def _start_journal(self) -> str:
        ...
        try:
            ...
            self._journal_proc = subprocess.Popen(
                ["stdbuf", "-oL", "journalctl", "-f", "-n", "20", "--no-pager", "-u", "dreambo-torso-daemon"],
