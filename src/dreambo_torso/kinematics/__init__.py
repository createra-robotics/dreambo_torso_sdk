...
try:
    from dreambo_torso.kinematics.nn_kinematics import NNKinematics  # noqa: F401
except ImportError:
    ...
    class MockupNNKinematics:
        ...
        def __init__(self, *args, **kwargs) -> None:  # type: ignore[no-untyped-def]
            ...
            raise ImportError(
                "NNKinematics could not be imported. Make sure you run pip install dreambo_torso_sdk[nn_kinematics]."
            )
...
try:
    from dreambo_torso.kinematics.placo_kinematics import PlacoKinematics  # noqa: F401
except ImportError:
    ...
    class MockupPlacoKinematics:
        ...
        def __init__(self, *args, **kwargs) -> None:  # type: ignore[no-untyped-def]
            """Raise ImportError when trying to instantiate the class."""
            raise ImportError(
                "PlacoKinematics could not be imported. Make sure you run pip install dreambo_torso_sdk[placo_kinematics]."
            )
...
from dreambo_torso.kinematics.analytical_kinematics import (  # noqa: F401
