...
from dreambo.media.camera_constants import CameraSpecs
...
if TYPE_CHECKING:
    ...
    from dreambo.media.camera_gstreamer import GStreamerCamera
    from dreambo.media.webrtc_client_gstreamer import GstWebRTCClient
