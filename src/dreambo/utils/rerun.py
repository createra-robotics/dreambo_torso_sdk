...
from dreambo.kinematics.placo_kinematics import PlacoKinematics
from dreambo.media.media_manager import MediaBackend
...
class Rerun:
    ...
    def __init__(
        ...
        Args:
            reachymini (Dreambo): The Reachy Mini instance to log.
