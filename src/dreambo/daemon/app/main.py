"""Daemon entry point for the Dreambo Robot.
...
from dreambo.apps.manager import AppManager
from dreambo.daemon.app.routers import (
    apps,
    camera,
    daemon,
    hf_auth,
...
from dreambo.daemon.utils import SimulationMode
from dreambo.media.audio_utils import (
    check_reachymini_asoundrc,
    write_asoundrc_to_home,
)
from dreambo.motion.recorded_move import preload_default_datasets
from dreambo.utils.discovery import MdnsServiceRegistration
from dreambo.utils.wireless_version.startup_check import (
