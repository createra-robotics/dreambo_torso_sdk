...
from dreambo.apps.manager import AppManager, AppStatus
from dreambo.daemon.app import bg_job_register
from dreambo.daemon.app.dependencies import get_app_manager
...
async def install_private_space(
    ...
    """
    from dreambo.apps.sources import hf_auth
...
async def check_app_updates(
    ...
    from dreambo.apps.sources import app_update_checker
